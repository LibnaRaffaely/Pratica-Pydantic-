...
class User(BaseModel):
    ...
    #Ao usar o mode=Wrap é relacionado à flexibilidade de faze 
    @model_serializer(mode="wrap", when_used="json")
    #o que vai ser serializado é a instância da classe (sel de User)
...
def main() -> None:
    ...
    if user:
        ...
        print(
            ...
            user.model_dump(exclude=["role"], mode="json"), # type: ignore
            sep="\n",
            end="\n\n",
        )
