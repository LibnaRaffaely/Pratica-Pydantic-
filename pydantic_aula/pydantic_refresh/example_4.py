...
class User(BaseModel):
    ...
    #configura o modelo para que caso o usuário envie dados 
    # extras sejam desconsiderados/esquecidos
    model_config = {
        "extra": "forbid",
    }
    ...
    # annotation default_factory serve para que caso os campos não 
    # sejam enviados sejam fornecidos automaticamente pelo servidor
    
    # kw_only=True: Garante que esses campos só possam ser passados 
    # como argumentos nomeados, evitando confusão na ordem dos dados.
